...
/*LONGSung*/
#define LONGS_9300C_VID 0x1C9E
#define LONGS_9300C_PID 0x9B3C

#define LONGS_8300_VID 0x1C9E
#define LONGS_8300_PID 0x9B05
...
static const struct usb_device_id option_ids[] = {
	{ USB_DEVICE(LONGS_9300C_VID, LONGS_9300C_PID) },
	{ USB_DEVICE(LONGS_8300_VID, LONGS_8300_PID) },
			...
			const struct usb_device_id *id)
{
	...
	if (is_blacklisted(
       ...
       /* sim7100 */
  /*     if (dev_desc->idVendor == cpu_to_le16(SIMCOM_SIM7100_VID) &&
            dev_desc->idProduct ==cpu_to_le16(SIMCOM_SIM7100_PID) &&
